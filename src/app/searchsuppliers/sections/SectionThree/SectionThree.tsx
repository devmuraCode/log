        ...
        <div className={styles.advantages_title_catd}>
          <div>
            <div className={styles.general_title}>
              ...
              <h1>Мы выделили некоторые преимущества сотрудничества</h1>
            </div>
            <p>
              ...
              отправкой из Китая. Наша основная цель - обеспечить быструю
              доставку вашего товара. В случае выявления дефектов мы обеспечим
              возврат товара поставщику. Доверьтесь опыту специалистов, получите
              комфортные и безопасные услуги доставки товаров от лучших
              китайских производителей на платформе 1688 в Россию.
            </p>
          </div>
        </div>
